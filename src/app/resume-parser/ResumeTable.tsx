...
export const ResumeTable = ({ resume }: { resume: Resume }) => {
  ...
  return (
    <>
      {!hidden && <div className="text-gray-400 text-xs cursor-pointer" onClick={(e)=>{setHidden(!hidden)}}>Hide</div>}
      {hidden && <div className="text-gray-400 text-xs cursor-pointer" onClick={(e)=>{setHidden(!hidden)}}>Show</div>}
